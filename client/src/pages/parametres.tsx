            ...
            <CardContent className="space-y-4">
              {user?.signatureUrl ? (
                <div className="border rounded-xl p-4 text-center">
                  <p className="text-sm text-muted-foreground">Signature enregistrée</p>
                </div>
              ) : (
                <div
          ...
          <Card className="glass rounded-xl mb-6 border-primary/20">
            ...
            <CardContent className="space-y-4">
              <p className="text-sm text-muted-foreground">
                ...
                à votre compte OrdoCAL.
              </p>
              {user?.ordocalUserId ? (
                <div className="flex items-center gap-3 p-3 rounded-lg bg-green-500/10 border border-green-500/20">
                  <CheckCircle2 className="size-5 text-green-500 flex-shrink-0" />
                  <div className="flex-1 min-w-0">
                    <p className="text-sm font-medium text-green-400">Compte OrdoCAL lié automatiquement</p>
                    <p className="text-xs text-muted-foreground">
                ...
                <div className="space-y-3">
                  <div className="flex items-center gap-3 p-3 rounded-lg bg-orange-500/10 border border-orange-500/20">
                    ...
                    <div className="flex-1">
                      <p className="text-sm font-medium text-orange-400">Aucun compte OrdoCAL détecté</p>
                      <p className="text-xs text-muted-foreground">
                        Aucun compte OrdoCAL n'a été trouvé avec l'email <strong>{user?.email}</strong>.
                        Créez un compte sur OrdoCAL avec le même email, puis cliquez sur Relancer.
                      </p>
                    </div>
                  </div>
                  <Button
                    ...
                    onClick={async () => {
                      ...
                      try {
                        ...
                        toast({ title: "Vérification en cours..." });
                      } finally {
